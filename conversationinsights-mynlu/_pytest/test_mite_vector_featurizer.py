...
twfe = total_word_feature_extractor("./data/total_word_feature_extractor_zh.dat")
...
print ("First 1000~1010 words in dictionary", words[100000:100010])
print ()
# Get features for one word
feats = twfe.get_feature_vector("home")
print ("The count of features of word 'home'", len(feats))
...
print ("The count of features of word '_word_not_in_dictionary_'", len(feats))
