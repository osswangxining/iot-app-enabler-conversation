...
class SklearnIntentClassifier(Plugin):
    """Intent classifier using the sklearn library"""
    ...
    def __init__(self, classifier=None, labelEncoder=None):
    ...
    def transform_labels_fit_transform(self, labels):
        # type: (List[Text]) -> np.ndarray
        """Transforms a list of strings from labels into numeric label representation.
        """
        return self.labelEncoder.fit_transform(labels)

    def transform_labels_inverse_transform(self, y):
        # type: (np.ndarray) -> np.ndarray
        """Inverse Transforms a list of numeric into a list of strings representation.
        """
    ...
    def train(self, training_data, config, **kwargs):
        ...
        if len(set(labels)) < 2:
            ...
            y = self.transform_labels_fit_transform(labels)
    ...
    def process(self, message, **kwargs):
        ...
        if not self.classifier:
            ...
            intents = self.transform_labels_inverse_transform(intent_ids)
