...
from mynlu.utils.json_to_md import JsonToMd
...
from mynlu.utils import lazyproperty, ordered
from mynlu.utils import list_to_str
...
class Message(object):
    ...
    def __str__(self):
        return 'Message(text=%s,data=%s,time=%s)' % (self.text, self.data, self.time)
